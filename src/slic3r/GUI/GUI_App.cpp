...
void GUI_App::load_current_presets(bool active_preset_combox/*= false*/, bool check_printer_presets_ /*= true*/)
{
    ...
    if (printer_technology == ptFFF && !edited_printer_preset.config.opt_bool("single_extruder_multi_material") && !is_multiple_filaments_per_nozzle_enabled(edited_printer_preset.config)) {
